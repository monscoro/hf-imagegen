...
exports.CURATED_MODELS = void 0;
exports.CURATED_MODELS = [
    {
        id: "black-forest-labs/FLUX.1-dev",
        description: "FLUX.1 Dev — Cutting-edge Qualität, exzellentes Prompt-Following. " +
    ...
    },
    {
        ...
        description: "FLUX.1 Schnell — Extrem schnell (1-4 Steps) durch Latent Adversarial Diffusion Distillation. " +
    ...
    },
    {
        ...
        description: "Krea 2 Turbo — Speziell für realistische Bilder optimiert. " +
    ...
    {
        id: "Qwen/Qwen-Image",
        description: "Qwen-Image — 20B Parameter. Exzellente Textdarstellung (besonders Chinesisch!), " +
    ...
    },
    {
        ...
        description: "SDXL — Bewährtes Ökosystem mit 9.600+ Adapters/LoRAs. " +
